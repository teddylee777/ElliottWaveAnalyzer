...
class WaveAnalyzer:
    ...
    def next_cycle(self, start_idx: int):
        ...
        for new_option_impulse in self.__waveoptions_up.options_sorted:
            ...
            waves_up = self.find_impulsive_wave(
                idx_start=start_idx, wave_config=new_option_impulse.values
            )
